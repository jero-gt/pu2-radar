function stemHold(lim_ejes,eje_x,eje_y,titulo,tam_letra,col1,col2,grosor,t,x1,x2,leyenda1,leyenda2)
    % stemCompleto(lim_ejes,'eje_x','eje_y','titulo',tam_letra,'col1','col2',grosor,t,x1,x2,'legend1','legen2')

    figure('units','normalized','outerposition',[0 0 1 1],'Name', titulo, 'NumberTitle', 'off'); % Creo y maximizo figura.
    stem(t,x1,col1,'Linewidth',grosor)
    hold on
    stem(t,x2,col2,'Linewidth',grosor)
